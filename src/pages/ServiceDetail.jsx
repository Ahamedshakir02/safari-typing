...
import { telLink, buildWhatsAppLink } from '../lib/wa.js'

function List({ title, items, icon }) {
  return (
    <Reveal className="rounded-2xl border border-navy/10 bg-white p-6 shadow-card sm:p-7">
...
export default function ServiceDetail() {
  ...
  return (
    <>
      ...
      {/* Hero */}
      <header className="bg-navy px-5 pb-16 pt-14 text-offwhite sm:px-8 sm:pt-16">
