...
/**
 * Slim credibility band right under the hero: accurate badges + count-up stats.
 * Stat numbers are placeholders — see CONTENT-NOTES.md.
 */
export default function TrustStrip() {
  return (
    <section aria-label="Why people trust us" className="bg-mist px-5 py-10 sm:px-8">
      <div className="mx-auto max-w-content">
        <ul className="flex flex-wrap items-center justify-center gap-x-6 gap-y-2 border-b border-navy/8 pb-8">
